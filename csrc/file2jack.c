...
NL "  --vol PERCENT  Soft volume (can be greater than 100%)"
NL "  --log-level N  Change log level (default: 5)"
NL ""
NL "Final LOOP option: [--at LPOS] --loop T0"
NL "  Repeats the T0-END segment from LPOS to infinity (where END is the"
NL "  end of the last file). Looping never moves the transport."
NL ""
NL "All positions can be given in seconds (e.g. 0.1) or samples (e.g. 480s)."
NL ""
